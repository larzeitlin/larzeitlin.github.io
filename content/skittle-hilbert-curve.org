...
* What is Skittle?
[[https://github.com/babashka/scittle][Skittle]] is is a small Clojure interpreter designed to be embedded inside applications, for example to evaluate Clojure input by the user.

** Aside
It's crazy how simple Skittle is to use. I'm writing in an [[https://orgmode.org][org file]] in Emacs. I embed some script tags in a [[https://orgmode.org/manual/Quoting-HTML-tags.html][export block]]. Like so:
...
* 1. Handle user input in Clojure
...
Lovely. Okay we don't care about the patterns any more, but we do want co change from cells to points. Let's grab the ordered cells and use the canvas dimensions to turn them into pixels.
