...
** Monad laws
Monads must satisfy the monad laws. Avoiding the technical language of the laws and just getting at their essence, these are satisfied by:
...
*** ret is a right-identity or bind
#+BEGIN_SRC
bind(ret(x)) == ret(x)
#+END_SRC
